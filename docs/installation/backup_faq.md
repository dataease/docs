...
!!! Abstract ""
    **基于DataEase 命令进行备份和恢复：**
    ...
    dectl backup 命令将 DataEase 排除日志目录以外的运行目录（如 /opt/dataease3.0）进行备份压缩，生成备份文件 DataEase备份文件.tar.gz。   
