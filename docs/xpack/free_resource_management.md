...
!!! warning "功能已移除"
    DataEase v3.0.0 起，【游离资源管理】功能已从系统设置中移除。资源归属管理统一由【系统设置-组织管理】与【系统设置-用户管理】协作负责（原【组织管理中心】已并入【系统设置】）。

!!! Abstract ""
    v2.x 及更早版本中，游离资源是指在没有组织管理下创建的资源，如在社区版中创建的资源，或是许可证到期后创建的资源。系统管理员可以在【系统设置】中管理这些游离资源，具体功能包括：
