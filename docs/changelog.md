...
!!! Abstract "新增功能 :star2:"
    ...
    - feat(仪表板): tab 组件支持选择其他组件(视频、流媒体、网页)
...
!!! Abstract "功能优化 :sunflower:"
    ...
    - refactor(视图): 视图编辑时检验 title 是否重复
    - refactor(视图): 视图编辑块优化
    ...
    - refactor(仪表板): 仪表板外部参数设置和视图跳转设置时，添加或选中参数时系统自动勾选启用框
    - refactor(仪表板): 复用模板时鼠标悬浮可显示仪表板全称
    - perf: 增大链接池
    - refactor: 增加系统默认模板
...
!!! Abstract "问题修复 :palm_tree:"
    ...
    - fix: 修复地图钻取后查看详情时范围没有切换的问题
    - fix: 动态时间最大值限制修改为 100 (#2082)
    - fix: 过滤条件关键字忽略大小写
    - fix: 修复组件背景设置图片预览出现双层遮罩无法关闭的问题
    - fix: 修复过滤组件选择字段显示不准确的问题
    - fix: 修复定时报告权限设置的问题
