...
!!! Abstract ""
    地图颜色支持设置渐变色及自定义渐变色
![更新1](../../newimg/地图颜色支持设置渐变色及自定义渐变色1.png){ width="900px" }

!!! Abstract ""
    在自定义渐变色时，可以通过设置起始和结束颜色，DataEase 会自动计算中间渐变色。
![更新1](../../newimg/地图颜色支持设置渐变色及自定义渐变色2.png){ width="900px" }
...
![更新1](../../newimg/透视表支持树形展示2.png){ width="900px" }
...
![更新1](../../newimg/漏斗图支持展示转化率.png){ width="900px" }
...
![更新1](../../newimg/明细表和汇总表支持行列冻结1.png){ width="900px" }
...
![更新1](../../newimg/图表支持配置提示信息轮播功能.png){ width="900px" }
...
![更新1](../../newimg/支持设置组件边框.png){ width="900px" }
...
!!! Abstract ""
    在制作在线地图时，地图风格选择【自定义】，URL 填入高德自定义地图分享的 URL 即可。详细设置可参考[地图设置](../system_management/param.md#3-地图设置)。
