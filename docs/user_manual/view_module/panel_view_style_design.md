...
![视图可选维度列表](../../img/view_generation/3.0数据大屏图表样式界面.png){ width="900px" }
...
!!! Abstract ""
    ...
    - 图表背景颜色设置；
    - 背景图片和边框设置。
![视图可选维度列表](../../img/view_generation/3.0数据大屏样式背景.png){ width="900px" }
...
![图形属性_修改颜色](../../img/view_generation/3.0数据大屏样式基础样式.png){ width="900px" }

!!! Abstract ""
    应用配色方案后，仍然可以进一步调整颜色，如下图所示，整个图表应用到的颜色都会在下方列出来，修改时不需要再在配色方案中选中，自行修改颜色后，配色方案中所展示的颜色将不会跟着改变。如下图所示。

![图形属性_自定义配色](../../img/view_generation/3.0数据大屏配色方案.png){ width="900px" }

![图形属性_自定义配色](../../img/view_generation/3.0数据大屏自定义颜色.png){ width="900px" }
...
![图形属性](../../img/view_generation/3.0数据大屏透明度.png){ width="900px" }
...
![更新1](../../newimg/数据大屏柱状图均支持圆角设置.png){ width="900px" }
...
![更新1](../../newimg/透视表树状展示.png){ width="900px" }
...
![组件样式_值与名称字体样式](../../img/view_generation/3.0数据大屏样式大小设置.png){ width="900px" }


!!! Abstract ""
    仪表盘支持在组件样式设置最小值、最大值、支持用图表指标来动态设置最大值和最小值，支持起始角度和结束角度设置。

![组件样式_AntV](../../img/view_generation/3.0数据大屏仪表盘动态值.png){ width="900px" }
...
![更新1](../../newimg/数据大屏符号地图现支持自定义气泡大小范围.png){ width="900px" }
...
![图形属性](../../img/view_generation/3.0数据大屏标签设置.png){ width="900px" }
...
![更新1](../../newimg/数据大屏标签显示支持全量和自适应两种模式.png){ width="900px" }
## 5 提示

!!! Abstract ""
    支持调整图表的”提示“字体大小、字体颜色，显示格式设置。

![组件样式_背景](../../img/view_generation/3.0数据大屏提示设置.png){ width="900px" }、
...
![组件样式_标题字体样式](../../img/view_generation/3.0数据大屏标题设置.png){ width="900px" }
...
![组件样式](../../img/view_generation/3.0数据大屏图例设置.png){ width="900px" }
...
![更新1](../../newimg/数据大屏地图支持自定义图例区间1.png){ width="900px" }

![更新1](../../newimg/数据大屏地图支持自定义图例区间2.png){ width="900px" }
...
![组件样式_设置格式化](../../img/view_generation/3.0数据大屏坐标轴横轴.png){ width="900px" }

!!! Abstract ""
    在纵轴设置中，除了坐标轴横轴的设置内容，还可对纵轴指标的显示进行格式和单位设置。

![坐标轴轴线显示控制](../../img/view_generation/3.0数据大屏坐标轴宗轴.png){ width="900px" }

!!! Abstract ""
    横纵轴支持快捷启用与禁用轴名称。

![更新1](../../newimg/数据大屏横纵轴支持快捷启用与禁用轴名称.png){ width="900px" }

!!! Abstract ""
    支持自定义轴线的显示，并调整其颜色、形状和宽度。

![更新1](../../newimg/数据大屏新增轴线颜色自定义设置.png){ width="900px" }
...
![组件样式_设置格式化](../../img/view_generation/数据大屏表格样式设置.png){ width="900px" }

!!! Abstract ""
    明细表和汇总表支持分页设置。

![更新1](../../img/view_generation/数据大屏汇总表分页展示.png){ width="900px" }

!!! Abstract ""
    透视表支持平铺展示和树形展示，同时支持指标展示支持选择按行头或列头展示，灵活调整展示方式。

![更新1](../../img/view_generation/透视表展示设置.png){ width="900px" }

![更新1](../../img/view_generation/透视表展示形式.png){ width="900px" }

![更新1](../../img/view_generation/数据大屏透视表新增行列转置功能.png){ width="900px" }

!!! Abstract ""
    透视表和明细表在配置数值字段汇总方式时。可根据字段需求选择求和、平均值、最大值、最小值等进行汇总展示。

![更新1](../../img/view_generation/数据大屏汇总表总计支持数值字段汇总方式配置.png){ width="900px" }
...
![更新1](../../newimg/数据大屏明细表支持表头分组1.png){ width="900px" }

!!! Abstract ""
    在表头分组设置页，可按住 Ctrl/Cmd  键选择表头列进行合并分组。注意：仅同级别表头可合并。

![更新1](../../newimg/数据大屏明细表支持表头分组2.png){ width="900px" }

!!! Abstract ""
    已合并的表头可通过左键选中，右键打开操作菜单进行管理。

![更新1](../../newimg/数据大屏明细表支持表头分组3.png){ width="900px" }


!!! Abstract ""
    明细表支持单元格合并。

![更新1](../../newimg/数据大屏明细表支持单元格合并.png){ width="900px" }

!!! Abstract ""
    明细表支持自动换行。    
    注意：自动换行功能启用后，表头的行高无法固定。在开启合并单元格时，自动换行则会失效。

![更新1](../../newimg/数据大屏明细表自动换行.png){ width="900px" }

!!! Abstract ""
    明细表和汇总表支持行列冻结。

![更新1](../../newimg/数据大屏明细表和汇总表支持行列冻结.png){ width="900px" }

![更新1](../../newimg/数据大屏明细表和汇总表支持行列冻结.gif){ width="900px" }
...
![更新1](../../newimg/数据大屏图表支持配置提示信息轮播功能.png){ width="900px" }

![更新1](../../newimg/数据大屏图表支持配置提示信息轮播功能.gif){ width="900px" }
...
![更新1](../../newimg/数据大屏在线地图功能增强.png){ width="900px" }

!!! Abstract ""
    在制作在线地图时，地图风格选择【自定义】，URL 填入高德自定义地图分享的 URL 即可。详细设置可参考[地图设置](../system_management/param.md#3)。

![更新1](../../newimg/数据大屏自定义地图风格.png){ width="900px" }

!!! Abstract ""
    地图支持自定义区域及其区域下钻。在【系统设置】→【系统参数】→【地图设置】中，可以添加自定义地理区域，并对中国省份进行自定义组合。
    具体设置可参考[地图设置](../system_management/param.md#3)。

!!! Abstract ""
    符号地图支持自定义符号形状。

![更新1](../../newimg/数据大屏符号地图支持自定义符号形状.png){ width="900px" }

!!! Abstract ""
    地图和气泡地图支持区域填充功能。

![更新1](../../newimg/数据大屏地图和气泡地图支持区域填充功能.png){ width="900px" }
