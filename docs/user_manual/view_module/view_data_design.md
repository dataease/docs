...
![可选指标列表](../../img/view_generation/2.0维度列表.png){ width="900px" }
...
![更新1](../../img/view_generation/指标卡支持显示同环比数据1.png){ width="900px" }
...
![更新1](../../img/view_generation/图表指标支持快速计算累加仪表板.png){ width="900px" }
...
![设置数值格式_指标卡展示结果](../../img/view_generation/2.0数值格式设置.png){ width="500px" }
...
![更新1](../../img/view_generation/图表过滤器支持复杂的与或条件设置.png){ width="900px" }


!!! Abstract ""
    图表过滤器支持动态日期，当图表需要依赖动态日期展示内容时，不再完全依赖筛选组件。

![更新1](../../img/view_generation/仪表板图表过滤器支持动态日期.png){ width="900px" }

![更新1](../../newimg/图表过滤器支持动态日期2.png){ width="900px" }
