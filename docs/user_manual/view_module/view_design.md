...
![编辑视图字段_求和占比_展示结果](../../img/view_generation/编辑视图字段_求和占比_展示结果.png){ width="900px" }
...
!!! Abstract ""
    ...
    v1.11.0 版本开始，维度选择过程中，对于拖入到各个框中的元素，提供便捷删除图标，直接点击后便可快速删除。
...
!!! Abstract ""
    ...
    v1.11.0 版本开始，指标选择过程中，对于拖入到各个框中的元素，提供便捷删除图标，直接点击后便可快速删除。
...
!!! Abstract ""
    设置数值格式化，目前仅 AntV 图库表格组件与指标卡支持数值格式化。
...
!!! Abstract ""
    DataEase v1.9.0 版本，视图编辑区新增【高级】模块，不同视图存在差异，根据各视图特性具备不同的高级功能。
...
!!! Abstract ""
    DataEase v1.12.0 版本，Echarts 明细表、汇总表，AntV 明细表，汇总表支持滚动设置，支持滚动行数和时间间隔设置；  
