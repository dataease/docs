...
![可选指标列表](../../img/view_generation/3.0数据大屏指标可选框.png){ width="900px" }
...
![更新1](../../newimg/数据大屏排序支持设置优先级1.png){ width="900px" }

![更新1](../../newimg/数据大屏排序支持设置优先级2.png){ width="900px" }
...
![同比环比](../../img/view_generation/累计不支持类型.png){ width="900px" }
...
![设置数值格式_指标卡展示结果](../../img/view_generation/数据大屏2.0数值格式设置.png){ width="500px" }
