...
![组件删除_基础功能](../img/panel_generation/数据大屏表格复制内容.png){ width="900px" }
...
![2.0数据大屏大小调整](../img/panel_generation/2.0数据大屏大小调整.gif){ width="900px" }
!!! Abstract ""
...
![2.0数据大屏位置移动](../img/panel_generation/数据大屏组件支持3D设置.png){ width="900px" }
...
![更新1](../img/panel_generation/数据大屏事件功能.png){ width="900px" }
...
![联动展示](../img/panel_generation/2.0联动效果.gif){ width="900px" }

!!! Abstract ""
	联动按钮始终固定在页面右上角，不随页面滚动而上移。

![更新1](../../newimg/数据大屏联动按钮固定悬浮在页面右上角.gif){ width="900px" }
...
![更新1](../img/panel_generation/数据大屏开启跳转设置以及设置内容.png){ width="900px" }
...
![跳转展示](../img/panel_generation/3.0数据大屏点击进行跳转.png){ width="900px" }
...
![更新1](../img/panel_generation/仪表板和数据大屏支持更多组件修改名称.gif){ width="900px" }
