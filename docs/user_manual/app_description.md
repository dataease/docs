...
![更新1](../newimg/移动端1.png){ width="300px" }![更新1](../newimg/移动端2.png){ width="300px" }![更新1](../newimg/移动端3.png){ width="300px" }

!!! Abstract ""
    可在移动端的编辑界面设置是否【开启移动端】。

![更新1](../newimg/开启移动端配置.png){ width="900px" }
...
![更新1](../newimg/设置移动端样式.png){ width="900px" }

!!! Abstract ""
     移动端组件可设置与 PC 样式同步功能。同步后，移动端组件的样式将与 PC 端保持一致；未同步时，若未单独设置移动端样式，则为最初选中时的 PC 端样式。

![更新1](../newimg/移动端组件新增PC样式同步功能.png){ width="900px" }
