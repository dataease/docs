...
![更新1](../newimg/支持数据集数据导出1.png){ width="900px" }

![更新1](../newimg/支持数据集数据导出2.png){ width="900px" }
## 2 新建数据集
!!! Abstract ""
...
!!! Abstract ""
    数据集编辑界面支持下拉框搜索。
![更新1](../img/dataset_configuration/数据集选择数据源和数据表.png){ width="900px" }
...
![新建数据库数据集](../img/dataset_configuration/新建数据库数据集1.png){ width="900px" }
...
![更新1](../img/dataset_configuration/SQL片段支持注释.png){ width="900px" }
...
![SQL参数设置](../../img/dataset_configuration/SQL 参数设置.png){ width="900px" }

!!! Abstract ""
    编写带变量的 SQL 语句后，系统默认将参数类型设置为文本，根据需要可在右上角【参数设置】里对变量进行相关设置，示例如：  
    若该变量为时间类型，请手动调整该参数类型的时间类型及时间格式。

![SQL参数变量类型](../../img/dataset_configuration/SQL 参数设置2.png){ width="900px" }

!!! Abstract ""
    参数设置里面，参数值下拉列表中可以选择“仅编辑时生效”或“数据集预览时全局生效”。   
    区别：仅编辑时生效在 SQL 数据集编辑界面有效，数据集预览时全局生效在数据集预览界面有效 。

![SQL参数生效模式](../../img/dataset_configuration/SQL 参数设置3.png){ width="900px" }
...
![查询组件设置参数设置](../img/dataset_configuration/时间传参搭配过滤组件.png){ width="900px" }
...
![更新1](../newimg/2.3 数据集自定义 SQL 时支持选择系统变量作为查询条件（XPack）.png){ width="900px" }
...
![拖拽关联表](../img/dataset_configuration/多次引用.png){ width="900px" }