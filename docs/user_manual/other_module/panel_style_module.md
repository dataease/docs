...
!!! Abstract ""
	...
	![富文本组件_功能](../../img/view_generation/3.0数据大屏富文本填入指标.png){ width="900px" }

!!! Abstract ""
	双击输入文字，可单独调整某文字样式。

![富文本组件_调整样式](../../img/view_generation/3.0数据大屏文本样式调整.png){ width="900px" }

!!! Abstract ""
	点击插入超链接按钮，可配置超链接，下示例图以插入”百度网页“链接为例。

![富文本组件_超链接](../../img/view_generation/3.0数据大屏设置超链接.png){ width="900px" }

!!! Abstract ""
	添加表格，输入文字，并可对表格单元格、行、列等做调整，如下图所示。

![富文本组件_超链接](../../img/view_generation/3.0数据大屏添加表格.png){ width="900px" }

![富文本组件_表格](../../img/view_generation/3.0数据大屏表格效果.png){ width="900px" }

!!! Abstract ""
	还支持插入图片、媒体。

![富文本组件_图片](../../img/view_generation/3.0数据大屏插入图片.png){ width="900px" }
...
![更新1](../../newimg/数据大屏新增分页组件.png){ width="900px" }
![更新1](../../newimg/数据大屏新增分页组件1.png){ width="900px" }
![更新1](../../newimg/数据大屏新增分页组件2.png){ width="900px" }
...
![更新1](../../newimg/数据大屏tab标题设置.png){ width="900px" }
...
![仪表盘编辑_其他组件](../../img/view_generation/3.0数据大屏素材添加边框.png){ width="900px" }

![仪表盘编辑_其他组件](../../img/view_generation/3.0数据大屏装饰.png){ width="900px" }

![仪表盘编辑_其他组件](../../img/view_generation/3.0数据大屏图形.png){ width="900px" }

![仪表盘编辑_其他组件](../../img/view_generation/3.0数据大屏图标.png){ width="900px" }
