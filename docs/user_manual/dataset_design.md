...
!!! Abstract ""
    勾选排序后，数据会进行升序排序。
![数据集排序](../img/quick_start/数据集排序.png){ width="900px" }
!!! Abstract ""
    在数据集预览界面导出数据集后依旧会对导出的数据进行升序排列。
![数据集排序2](../img/quick_start/数据集排序1.png){ width="900px" }
![数据集排序2](../img/quick_start/数据集排序2.png){ width="900px" }
...
![字段时间解析](../img/dataset_configuration/支持图片url.png){ width="900px" }

![更新1](../newimg/明细表支持显示图片2.png){ width="900px" }
...
![更新1](../img/dataset_configuration/全连接.png){ width="900px" }