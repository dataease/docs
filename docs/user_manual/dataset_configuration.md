...
## 场景构建
> 点击【销售额分析】场景，进入场景构建模块，功能如下：</br>【序号1】添加数据集，点击可添加新数据集；</br>【序号2】为搜索功能区，可输入关键字搜索，快速锁定目标表；</br>【序号3】为数据表预览，表关系创建，以及数据表更新时间、频率设置和数据刷新等操作功能区；</br>【序号4】功能区，可对数据表重命名和删除；</br>【序号5】功能区，可对数据表字段删减、字段重命名等；</br>【序号6】，退出场景构建模块。
...
![数据库数据集](../img/dataset_configuration/添加数据库表.png)
...
#### 2.2.2 删除关联
> 点击关联关系右侧的【删除】，弹出如下提示框，点击【取消】，取消删除；点击【确定】，删除成功。

![编辑关联](../img/dataset_configuration/删除关联.png)
