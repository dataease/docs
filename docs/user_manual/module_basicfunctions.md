...
![组件位置及大小](../img/dashboard_generation/事件设置.png){ width="900px" }
...
![设置联动字段](../img/dashboard_generation/2.0仪表板进行联动设置2.png){ width="900px" }
...
![更新1](../../newimg/仪表板跳转设置的弹窗页面样式变更为内嵌式弹窗.gif){ width="900px" }
...
![更新1](../newimg/图表跳转支持携带查询组件的过滤值并传递给外部参数1.PNG){ width="900px" }
...
![更新1](../newimg/20图表跳转支持携带查询组件的过滤值并传递给外部参数3.png){ width="900px" }
...
![更新1](![img.png](img.png)../../newimg/1.10 下钻和联动支持配置同时触发3.gif){ width="900px" }

## 8 组件样式
!!! Abstract ""
	所有组件均支持通过双击组件编辑区域的名称进行改名操作。

![更新1](../newimg/仪表板支持更多组件修改名称.gif){ width="900px" }
...
![更新1](../img/dashboard_generation/仪表板组件样式设置.png){ width="900px" }	
